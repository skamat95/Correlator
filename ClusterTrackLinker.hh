...
const ap_ufixed<10,2> conv_track_eta_calc = 0.0287356; //NCrystalsInEta / MaxTrackEta;
...
const ap_ufixed<10,2> conv_track_phi_calc = 0.0057296; //NCrystalsInPhi / MaxTrackPhi;
